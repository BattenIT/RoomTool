# Trumba MCP Setup Script (User Version - No Admin Required)
...
if ($LASTEXITCODE -eq 0) {
    ...
    Write-Host "You may need to install Node.js manually from https://nodejs.org" -ForegroundColor Yellow
}
...
Write-Host "• trumba_get_registrations - Get event registrations with filtering" -ForegroundColor White
Write-Host "• trumba_get_event_summary - Generate event summaries" -ForegroundColor White
Write-Host "• trumba_search_attendee - Find attendees by name/email" -ForegroundColor White
Write-Host "• trumba_get_recent_registrations - Monitor recent activity" -ForegroundColor White
Write-Host "• trumba_export_registrations - Export data in multiple formats" -ForegroundColor White
Write-Host ""
